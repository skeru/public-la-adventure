...
\newcommand\cluas{Cluas a Geàrra}
\newcommand\spog{Spòg Nan Sionnach}
\newcommand\vate{Vate}
\newcommand\governatore{Sextus Domitius Mircianus}
\newcommand\minio{Minio Matholwch}
\newcommand\pupius{Ellfin Pupius}
\newcommand\musico{Il Musico Bicentenario}
...
\lasubsection{Parte I -- Fiamme di Guerra}
%
...
\lasubsection{Parte II -- Eco dal Passato}
...
\lasubsection{Parte III -- La Battaglia pi\`{u} Lunga}
...
{16}
Assistente e consigliere personale di \npcref{\governatore}.
...
\section{Incaricati di Non Trovare Nulla}
%
La lettera di convocazione per l'incarico giunge da Londinium e riporta il sigillo del governatore \npcref{\governatore} (Vedi manuale Britannia~\cite{britannia_en} -- pagina 25 per approfondimenti).
...
\npcref{\governatore} riceve i custodes ed illustra loro il problema.

\npcref{\governatore} -- \say{%
...
\npcref{\governatore} conversa con i custodes per circa un'ora e risponde ad eventuali domande che loro possano avere.
...
Dovessero i custodes chiedere ulteriore assistenza, SDM lascia uno dei suoi assistenti in compagnia dei custodes: \npcref{\pupius}.


\section{Gatti, Pecore, e Torbiere}
%
\monster{\minio}{
\dvstat{6}
...
Quando il servitore non \`{e} di turno, o per qualunque motivo non lascia doni, \monsterref{\minio} lancia uno dei suoi dispetti sugli avventori.
Il suo dispetto preferito \`{e} far marcire la birra appena spillata nei boccali.

\monsterref{minio} appartiene alla razza Br\`{u}nei dei fatui clari. Vedi manuale Britannia~\cite{britannia_en} a pagina 178.
...
Si tratta di \monsterref{\minio}.
Non sar\`{a} possibile catturare \monsterref{\minio} in alcun modo prima dell'arrivo a Pons Aelius.

Se decidono di fermarsi in una locanda, i custodes incontrano \npcref{\musico}, il quale riscuote discreto successo tra gli avventori. Quando si accorge della presenza di legionari, \npcref{\musico} cerca di evitare di attirare l'attenzione su di s\'{e} e canta solo in lingua celtica.
...
Un \tiro{De Societate}{3} far\`{a} notare ai custodes che la maggior parte della popolazione brigante locale apprezza ed elogia le gesta di \npcref{\geordie} nel villaggio: chi lo definisce il miglior panettiere, chi un ottimo macellaio, un fabbro affidabile, e perfino un pescatore molto generoso. Per capire o avere la conferma che non si tratti della stessa persona ma bens\`{i} di un nome molto comune, serve un \tiro{Ingenium}{6}.
...
Stanno costruendo un patibolo per eseguire la sentenza di condanna di \npcref{\geordie}.
...
Se interpellata, domanda ai custodes di intercedere per salvare \npcref{\geordie}, il suo promesso sposo.

\section{Gabbia di Morte}
%
L'esecuzione di \npcref{\geordie} \`{e} prevista per il secondo giorno successivo all'arrivo dei custodes.
Durante la notte, le fiaccole della trib\`{u} di \npcref{\geordie} si possono vedere in un accampamento a sud delle mura.
...
%
Sulla collina il patibolo \`{e} pronto per l'impiccagione, mentre \npcref{\geordie} aspetta in una cella del castrum.
...
\section{Musica di Altri Tempi}
%
\npcref{\musico} passa per caso dalla taverna del villaggio, fa il suo spettacolo, ma quando capisce che qualcosa di funesto sta per accadere, decide di lasciare Pons Aelium in cerca di locande meno pericolose.
...
Nel caso in cui non sia gi\`{a} stato introdotto al seguito del contubernium, \npcref{\pupius} raggiunge i custodes per chiedere aggiornamenti riguardo le loro indagini e offrir\`{a} collaborazione per indagare.


Dopo essersi ripreso dalle ferite in un nascondiglio segreto poco lontano, l'antico arcibardo \npcref{\cluas} si fa trovare da \npcref{\pupius} e chiede un incontro coi custodes.
Lui non parla bene latino, e chiede l'intervento di \npcref{\pupius} come interprete.
\npcref{\cluas} si accinge a guidare i custodes verso il luogo dove il rituale per manipolare lo spazio-tempo venne officiato, nella miniera di antimonio.
...
\npcref{\cluas} racconta di non essere stato lui ad officiare il rituale, bens\`{i} \npcref{\spog}, il quale si trova ancora nel reame fatato.
Solo Sp\`{o}g \`{e} capace di una magia cos\`{i} potente, mentre \npcref{\cluas} pu\`{o} al massimo prolungare di alcune ore o al massimo dei giorno l'effetto della magia.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\part{La Battaglia pi\`{u} Lunga}
%
\section{Vecchi Nemici}
%
...
I custodes possono negoziare con i briganti per il rilascio di \npcref{\geordie}.
Un \tiro{De Societate (Negoziare)}{6} porta i seguenti risultati.
Il grado di difficolt\`{a} scende a 3 se i custodes portano dei doni o si offrono di intercedere per liberare \npcref{\geordie}.

\emph{I grado di successo}:\\
I briganti non assaltano il forte e si ritirano immediatamente con \npcref{\geordie}.

\emph{II grado di successo}:\\
I briganti ripagano i danni causati da \npcref{\geordie} e porgono scuse ufficiali.

\emph{III grado di successo}:\\
I briganti forniranno aiuto militare ai custodes per difendere il Vallo nei giorni a seguire in cambio della libert\`{a} di \npcref{\geordie}.
